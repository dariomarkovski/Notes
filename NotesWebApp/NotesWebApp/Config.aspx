            ...
            <div class="body-wrap">
                ...
                <div class="center-div">
                    <div class="register-wrap-body-element">
                        ...
                        <asp:TextBox ID="currPwTb" runat="server" CssClass="input-text-box" TextMode="Password"></asp:TextBox>
                    ...
                    <div class="register-wrap-body-element">
                        ...
                        <asp:TextBox ID="newPwTb" runat="server" CssClass="input-text-box" TextMode="Password"></asp:TextBox>
                    ...
                    <div class="register-wrap-body-element">
                        ...
                        <asp:TextBox ID="confirmNewPwTb" runat="server" CssClass="input-text-box" TextMode="Password"></asp:TextBox>
                    ...
                    <div class="register-wrap-body-element">
                        ...
                        <br />
                        <asp:Label ID="pwChangeLabel" runat="server"></asp:Label>
                    </div>
                </div>
